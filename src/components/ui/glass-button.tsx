...
const variantClasses: Record<Variant, string> = {
  ...
  outline:
    "glass-surface text-white/90 hover:bg-white/10 hover:text-white",
};
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060814]",
    ...
    >
      {loading && (
        <span
          aria-hidden
          className="size-4 rounded-full border-2 border-white/40 border-t-white animate-spin-slow"
        />
      )}
      {children}
    </button>
